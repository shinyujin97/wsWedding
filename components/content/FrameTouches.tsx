...
export default function FrameTouches() {
  ...
  return (
    <>
      ...
      {hintShown && !DEBUG && (
        <span
          className="absolute z-30 -translate-x-1/2 rounded-full border border-[#c2a06c]/45 bg-white/95 px-2.5 py-1 text-[12px] md:text-[14px] font-jua tracking-[0.12em] text-stone-700 shadow-md ring-2 ring-white/50 whitespace-nowrap animate-pulse pointer-events-none"
